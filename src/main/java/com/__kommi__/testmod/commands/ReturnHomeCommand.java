package com.__kommi__.testmod.commands;
...
public class ReturnHomeCommand {
    ...
    private int returnHome(CommandSource source) throws CommandSyntaxException {
        ...
        boolean hasHomepos = player.getPersistentData().getIntArray(TestMod.MOD_ID+"homepos").length != 0;

        if(hasHomepos) {
            int[] playerPos = player.getPersistentData().getIntArray(TestMod.MOD_ID+"homepos");
